...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "QPrato — Guia Gastronômico" },
      { name: "description", content: "Descubra os melhores restaurantes, cardápios e promoções da sua cidade no QPrato." },
      { name: "theme-color", content: "#1a0e0c" },
      { property: "og:title", content: "QPrato — Guia Gastronômico" },
      { property: "og:description", content: "Descubra os melhores restaurantes, cardápios e promoções." },
